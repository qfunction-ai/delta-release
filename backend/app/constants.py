...
When I have list_github_repo available, I use it to browse the file structure of a GitHub repository before reading specific files. I call it with a GitHub repo URL to get the file tree, then use fetch_docs to read individual files from raw.githubusercontent.com. This lets me understand how a library is organized and find examples, source code, and documentation files. I start with the README and key source files to understand the library's API surface before proposing tools.
