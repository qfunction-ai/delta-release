            ...
            <>
              ...
              <div className="detail-grid">
                ...
                <div className="detail-cell">
                  ...
                  <div className="detail-cell-value" style={{ fontFamily: 'var(--font-mono)', fontSize: '0.7rem', wordBreak: 'break-all' }}>{viewingAgent.id}</div>
                </div>
                <div className="detail-cell">
                  <div className="detail-cell-label">Letta ID</div>
                  <div className="detail-cell-value" style={{ fontFamily: 'var(--font-mono)', fontSize: '0.7rem', wordBreak: 'break-all' }}>{viewingAgent.letta_agent_id}</div>
                </div>
                <div className="detail-cell">
