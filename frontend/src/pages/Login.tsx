...
export default function Login() {
  ...
  if (needsSetup) {
    return (
      <div className="login-page">
        {/* Corner math symbols */}
        <div style={{ position: 'fixed', top: '-1rem', left: '1.5rem', fontFamily: 'var(--font-mono)', color: 'rgba(253,176,34,0.06)', fontSize: '6rem', fontWeight: 300, pointerEvents: 'none', zIndex: 0, lineHeight: 1 }}>λ</div>
        <div style={{ position: 'fixed', top: '-1rem', right: '1.5rem', fontFamily: 'var(--font-mono)', color: 'rgba(253,176,34,0.06)', fontSize: '6rem', fontWeight: 300, pointerEvents: 'none', zIndex: 0, lineHeight: 1 }}>Σ</div>
        <div style={{ position: 'fixed', bottom: '-1rem', left: '1.5rem', fontFamily: 'var(--font-mono)', color: 'rgba(253,176,34,0.06)', fontSize: '6rem', fontWeight: 300, pointerEvents: 'none', zIndex: 0, lineHeight: 1 }}>∫</div>
        <div style={{ position: 'fixed', bottom: '-1rem', right: '1.5rem', fontFamily: 'var(--font-mono)', color: 'rgba(253,176,34,0.06)', fontSize: '6rem', fontWeight: 300, pointerEvents: 'none', zIndex: 0, lineHeight: 1 }}>∞</div>
  ...
  return (
    <div className="login-page">
      ...
      {/* Version stamp */}
      <div style={{ position: 'fixed', bottom: '1rem', right: '1.5rem', fontFamily: 'var(--font-mono)', fontSize: '0.625rem', color: 'var(--text-tertiary)', opacity: 0.4, letterSpacing: '0.05em', zIndex: 1 }}>v0.1.0 // δ-build</div>
    </div>
  )
}
